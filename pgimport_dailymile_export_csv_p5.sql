...
DROP TABLE imported_entries_p5;
...
CREATE table imported_entries_p5 (id integer primary key, url text, entry_date timestamp, title text, activity_type text, felt text, duration_seconds integer, distance NUMERIC(7,4), distance_units text, description text);
